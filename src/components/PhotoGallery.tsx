    ...
    <section className="section gallery-section">
      <div className="section-inner">
        ...
        <div className="gallery-grid">
          ...
          >
            <img src={featured.image} alt={lang === "hi" ? featured.caption : featured.captionEn} className="gallery-img" loading="lazy" decoding="async" />
          ...
          {rest.map((photo, i) => (
            ...
            >
              <img src={photo.image} alt={lang === "hi" ? photo.caption : photo.captionEn} className="gallery-img" loading="lazy" decoding="async" />
              <div className="gallery-overlay">
                <div className="gallery-overlay-text">
