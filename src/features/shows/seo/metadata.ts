...
export const showsMetadata: Metadata = {
  title: "Shows & Videos",
  description:
    "Watch News Kothri shows, explainers, and video reports with the latest updates across India and the world.",
  alternates: { canonical: toAbsoluteUrl("/shows") },
  openGraph: {
    title: `Shows & Videos | ${siteName}`,
    description:
      "News shows, deep dives, and video bulletins from News Kothri.",
