...
export const metadata: Metadata = {
  ...
  description:
    "Learn how News Kothri uses cookies and browser storage for secure sessions, preferences, and product improvements.",
  alternates: { canonical: toAbsoluteUrl("/cookies") },
  openGraph: {
    title: `Cookies policy | ${siteName}`,
    description:
      "Cookie categories, controls, and browser storage practices for News Kothri readers.",
